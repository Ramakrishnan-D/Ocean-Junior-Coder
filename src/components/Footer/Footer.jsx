...
export default function Footer(){
    ...
    <p>Ocean was founded on the principle of building, and implementinggreat ideas that drive progress for the students ond clients.</p>
    </div>
    ...
    <div className="FooterContact">
        <p>CONTACT</p>
        <div className="FooterIcon"><div><FaMobile className="Icon"/> </div> <p >0413-2240580 </p></div>
